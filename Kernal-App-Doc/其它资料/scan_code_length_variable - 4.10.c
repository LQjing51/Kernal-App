...
const unsigned long long BASE_Map[BASE_MAP_SIZE] = {
    ...
    18437773157604532448ull, 0, 18437773157600338146ull, 18437773157600338147ul, 0, 0, 0, 18446727580313731103ull, 0, 0,
    0, 18446727580313731135ull, 0, 0, 0, 18446727580313731167ull, 0, 0, 0, 18446727580313731199ull, 
    0, 0, 0, 18446727580313731231ull, 0, 0, 0, 18446727580313731263ull, 0, 0, 
